...
@Component
public class ChatInfoDaoImpl extends AbstractDaoImpl implements ChatInfoDao {
...
//			+ " left outer join user_info ui on (css.agent_id = ui.agent_id) ";
	public ChatInfoDaoImpl(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
